...
@dataclass
class DataArgs:
    model_name_or_path: str = field(default='/home/niwang/models/llama-7b-hf')  # tokenizer所在目录
    data_path: str = field(default="/home/niwang/data/alpaca-cleaned")  # 待预处理的数据所在目录
    save_dir: str = field(default="/home/niwang/data/saved")  # 保存预处理后的数据的存放目录
