...
def parse_arguments():
    ...
    parser.add_argument('--data_path', type=str, default='/home/niwang/data/saved', help="数据所在位置")
    parser.add_argument("--model_name_or_path", type=str, default='/home/niwang/models/llama-7b-hf', help="模型文件位置")
    ...
    parser.add_argument("--local_rank", type=int, default=0, help="多机多卡情况下的local_rank")
